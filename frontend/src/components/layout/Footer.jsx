    ...
    return (
        <div className="flex md:flex-row text-indigo-500 justify-between  p-6 pt-16 bg-indigo-100">
            ...
            <div>
                ...
                <form className="">
                    <input className="border border-indigo-100 border-b-indigo-500" type="Email" />
                    <div className="pr-12 flex">
                        <p className="mt-3">Wanna Subscribe to newsletter</p>
                        <button className="ml-3 rounded-full border border-indigo-500 hover:bg-indigo-200 focus:outline-none focus:border-indigo-600 font-bold px-6 py-2">Submit</button>
                    </div>
                </form>
            </div>
